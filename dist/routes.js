...
const CreateProductCotroller_1 = require("./controllers/products/CreateProductCotroller");
...
router.post('/product', isAuthenticated_1.isAuthenticated, new CreateProductCotroller_1.CreateProductController().handle);
